...
class MockHaystackIndexesSearchIndex(object):
    pass


class MockHaystackIndexesIndexable(object):
    pass


# class BaseIndex(indexes.SearchIndex, indexes.Indexable):
class BaseIndex(MockHaystackIndexesSearchIndex,
                MockHaystackIndexesIndexable):
    """
