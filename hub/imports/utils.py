...
def get_base_kwargs(columns, column_mappings, row,
    ...
    """
    title_key = "Title"
    if column_mappings.has_key('title'):
        title_key = column_mappings['title']
        
    description_key = "Description"
    if column_mappings.has_key('description'):
...
def get_base_m2m(parent, columns, column_mappings, row):
    """
            ...
            if name:
                ...
                if org_id:
                    try:
                        ...
                        print "Organization does not exist: %s (%d)" % (org_name, org_id)
    ...
    for i in range(1, 3):
        ...
        if key in columns:
            ...
            if url:
                create_file_from_url(parent, url)
